...
Rails.application.config.assets.paths << Rails.root.join('vendor','bfonts')
Rails.application.config.assets.paths << Rails.root.join('vendor','afonts')
Rails.application.config.assets.paths << Rails.root.join('vendor','cfonts')
...
Rails.application.config.assets.precompile += %w( *.php )
